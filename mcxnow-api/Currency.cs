...
namespace mcxNOW
{
    public sealed class Currency
    {
        ...
        public static readonly Currency PPC = new Currency(9, "PPC", "PeerCoin");
        public static readonly Currency MCX = new Currency(10, "MCX", "mcxFEE");
        public static readonly Currency FTC = new Currency(11, "FTC", "Feathercoin");
